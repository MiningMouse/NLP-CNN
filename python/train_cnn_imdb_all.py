...
# Load data
print("Loading data...")
neg_train_path = './data/imdb_train_all.neg'
pos_train_path = './data/imdb_train_all.pos'
...
train_n = int(len(x_shuffled)*0.8)

# test data
d_test = x_shuffled[train_n:]
l_test = y_shuffled[train_n:]

# train data
x_shuffled = x_shuffled[0:train_n]
y_shuffled = y_shuffled[0:train_n]
